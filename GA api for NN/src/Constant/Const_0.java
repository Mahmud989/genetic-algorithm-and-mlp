...
//    }
    public static void setFunction(Functions<Double, Double> function) {
        Const_0.function2 = function;
    }

    public static void setSearch(int Search) {
        Const_0.Search = Search;
    }
